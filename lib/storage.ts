...
export const DEFAULT_SETTINGS: Settings = { enabled: { taobao: true, '1688': true }, autoTranslateAll: true, manualRate: '', onlineFallback: true, ocrLanguage: 'chi_sim', panelSize: 'standard' };
